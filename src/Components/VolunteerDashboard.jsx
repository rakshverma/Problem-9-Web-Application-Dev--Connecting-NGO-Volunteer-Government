...
const VolunteerDashboard = () => {
  ...
  const redirectSearch = () => {
    navigate(`/volunteer/${localStorage.getItem("userId")}/dashboard/search`);
  };
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      {profileModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            <h2 className="text-xl font-bold mb-4 text-blue-700">👤 User Profile</h2>
            <p>
              <strong>Name:</strong> {userProfile.username || "N/A"}
            </p>
            <p>
              <strong>Email:</strong> {userProfile.email || "N/A"}
            </p>
            <p>
              <strong>Role:</strong> {userProfile.role || "Volunteer"}
            </p>
            <button
      ...
      <button
        ...
        className="mt-4 bg-purple-500 text-white px-5 py-3 rounded-lg hover:bg-purple-600 transition-all"
      >
        🔍 See Projects
      </button>
    </div>
